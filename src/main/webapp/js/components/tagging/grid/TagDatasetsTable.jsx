...
import { Table, Button, InvertedTriangle } from 'tfs-ui';
...
export class TagDatasetsTable extends Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps, mapDispatchToProps)(TagDatasetsTable);
