...
import { cellEditableManualTagSuggestReducer, defaultState } from 'state/reducers/cellEditableManualTagSuggestReducer_reducers';

describe('cellEditableManualTagSuggestReducer', () => {
