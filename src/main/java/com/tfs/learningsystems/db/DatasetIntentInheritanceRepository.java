...
@Component
public interface DatasetIntentInheritanceRepository extends
    CrudRepository<DatasetIntentInheritanceBO, Integer>,
    JpaSpecificationExecutor<DatasetIntentInheritanceBO> {
