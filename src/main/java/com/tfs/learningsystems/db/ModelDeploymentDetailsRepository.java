...
@Component
public interface ModelDeploymentDetailsRepository extends CrudRepository<ModelDeploymentDetailsBO, Integer>,
    JpaSpecificationExecutor<ModelDeploymentDetailsBO> {
