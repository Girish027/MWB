...
@Component
public interface TaggingGuideColumnMappingRepository extends
    CrudRepository<TaggingGuideColumnMappingBO, Integer>,
    JpaSpecificationExecutor<TaggingGuideColumnMappingBO> {
