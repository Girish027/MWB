...
@Component
public interface TaggingGuideImportStatRepository extends
    CrudRepository<TaggingGuideImportStatBO, Integer>,
    JpaSpecificationExecutor<TaggingGuideImportStatBO> {
